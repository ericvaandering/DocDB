...
sub TalkNotePopupScript {
  ...
  print "window.open(page,\"docdbhelp\",\"width=800,height=350,menubar=0,resizable=1,scrollbars=1,status=0,titlebar=0,toolbar=0,left=0,top=0\");\n";
  print "}\n";
...
sub TalkNoteLink { #FIXME Don't hard-code link
  my ($SessionTalkID) = @_;
