...
sub CertificateInstructionsSidebar {
  ...
  <ul>
   ...
   <li><a href="#register">Register your certificate with DocDB</a></li>
   <li><a href="#import">Importing and Exporting certificates</a></li>
   <li><a href="#protect">Protect your certificate</a></li>
   <li><a href="#test">How to test your certificate</a></li>
   <li><a href="#same">Same machine</a></li>
   <li><a href="#issues">Known issues with certificates</a></li>
  </ul>
TOC
}
...
machines by <a href="#import">exporting</a> 
it to a file and then <a href="#import">importing</a> 
...
<li> Import the certificate into your browser - first time
    <ul>
    <li> Use the <a href="#same">same physical machine</a>, 
...
<li> Save (<a href="#import">export</a>) the certificate 
...
<li> Finally, <a href="#register">register</a> your certificate with 
...
<li> If your certificate was not imported, see 
     <a href="#import">these instructions</a>.
</li>
<li> If you want, test your certificate by going to 
     <a href=http://security.fnal.gov/pki/browsercerttest.html>http://security.fnal.gov/pki/browsercerttest.html</a>
...
<li> GetCert method:
  ...
  <li> <b>cd kca</b> and choose one of the following options
       ...
       <li>  <b>./get-cert.sh</b> <br>
             ...
             You will need to manually <a href="#import">import</a> the certificate.
        </li>
       <li> Close your browser. <br>
	    ...
	    your browser.  If it does not, 
            manually <a href="#import">import</a> the certificate.
        </li>
       </ol>
        </li>
...
<li> In a browser that has had your certificate imported, 
     go to the secure $ShortProject document database page: 
      <a href="$secure_entry">$secure_entry</a> 
...
<li> To export a certificate from your browser:
   ...
   <li> <a href="#protect">Protect your certificate.</a>
   </li>
   <li> For Firefox: 
        <ul>
	<li> <font color="maroon"> Linux:</font> 
...
<a name="test"/>
<h1>How to test your certificate</h1>
<p> 
The Computing Division provides a 
<a href=http://computing.fnal.gov/security/pki/browsercerttest.html>certificate test facility</a>.
</p> 
